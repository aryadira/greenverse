          ...
          <div className='right w-full max-w-[295px] mt-12 md:mt-0'>
            <ul className='flex flex-col'>
              ...
              <div className='btn w-full'>
                <Link>
                  <Button className={`bg-white border text-black hover:-translate-y-2 mt-7`}>Join Us</Button>
                </Link>
                <Link to={"/"}>
                  <Button className={`bg-transparet text-white border-[1px] hover:-translate-y-2 mt-7`}>Back to top</Button>
                </Link>
              </div>
            </ul>
          </div>
