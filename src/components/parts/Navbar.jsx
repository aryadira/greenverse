        ...
        <ul className="w-[20%] text-xl leading-10 block">
          <li>
            <Link
              ...
              to={"/products"}
              className="links mb-4 max-w-fit block"
            >
              Discover All
            </Link>
            <Link
              onClick={() => window.scrollTo(0, 0)}
              to={"/products/brassica"}
              className="links max-w-fit block"
            >
              Brassica
            </Link>
            <Link
              onClick={() => window.scrollTo(0, 0)}
              to={"/products/cover-crop-mixes"}
              className="links max-w-fit block"
            >
              Cover Crop Mixes
            </Link>
            <Link
              onClick={() => window.scrollTo(0, 0)}
              to={"/products/grasses-millets-sorghums"}
              className="links max-w-fit block"
            >
        ...
        <ul className="w-[20%] text-xl leading-10">
          <li>
            <Link
              onClick={() => window.scrollTo(0, 0)}
              to={"/services"}
              className="mb-4 links max-w-fit block"
            >
              Discover All
            </Link>
            <Link
              onClick={() => window.scrollTo(0, 0)}
              to={"/services/green-infrastructure"}
              className="links max-w-fit block"
            >
            ...
            <Link
              onClick={() => window.scrollTo(0, 0)}
              to={"/services/agriculture-plantation"}
              className="links max-w-fit block"
            >
        ...
        <ul className="lg:w-[16%] text-xl leading-10 ">
          ...
          <div className="flex text-base items-center mt-5 border-t  py-5">
            ...
            <Link onClick={() => window.scrollTo(0, 0)} to={"/signup"}>
              <Button className={`bg-[#313A36] text-white hover:bg-[#0f231a]`}>
                Join Us
              </Button>
            </Link>
          </div>
...
const Navbar = () => {
  ...
  return (
    <header
      className={`w-full bg-white top-0 fixed z-10`}
      id="#top"
      onMouseLeave={() => overlayDownOff()}
    >
      <SpacingLayout>
        <BoxContainer>
          <nav className="navbar flex justify-between py-3 items-center z-20 bg-white">
            <div className="logo">
              <Link
                onClick={() => window.scrollTo(0, 0)}
                to={"/"}
                className="font-HaasBd text-2xl"
              >
                Greenverse
              </Link>
            </div>
            ...
            <div className="lg:flex text-base hidden items-center">
              ...
              <Link onClick={() => window.scrollTo(0, 0)} to={"/signup"}>
                <Button
                  className={`bg-[#313A36] text-white hover:bg-[#0f231a]`}
                >
                  Join Us
                </Button>
              </Link>
