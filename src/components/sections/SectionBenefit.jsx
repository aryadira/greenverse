...
const sectionBenefit = () => {
  ...
  useEffect(() => {
    ...
    tl.set(".left-img", { xPercent: 200, opacity: 0 })
      .to(".left-img", { y: 10, duration: 2 })
      .to(".left-img", { xPercent: 0, duration: 2, opacity: 100 })
      .to(".left-img", { y: 0, duration: 4 });
          ...
          <div className="right-benefit gap-3 grid grid-cols-2">
            {benefits.map((benefit) => (
              ...
              <div className="card pt-[20px] px-[10px] pb-[50px] bg-white rounded-[30px]">
                ...
                <h3 className="title-heading my-[10px] mx-[10px] text-2xl  font-HaasMd">
                  {benefit.title}
                </h3>
