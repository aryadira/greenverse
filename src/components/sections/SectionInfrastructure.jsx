    ...
    <div className="wrapper">
        <div className="container flex w-full justify-evenly items-center ">
            <div className="left-content w-[35%]">
                ...
                <p className='w-full text-[18px] my-2 leading-none text-[#676767]'>There is a broad spectrum of smart irrigation technology that consumers can benefit from utilizing. Choosing the correct technology for the situation is essential to achieve potential water savings.</p>
        ...
        <div className="container flex w-full mt-5 justify-evenly items-center ">
            ...
            <div className="left-content w-[35%] mt-10">
                ...
                <p className='w-full text-[18px] my-2 leading-none text-[#676767]'>Plantation agriculture is the clearing of forest or land to create an area of farming for one specific crop, which is grown on a large scale.</p>
                <div className="btn-left mt-10">
                    <a href="" className='py-3 px-5 rounded-full bg-[#313A36] text-white'>Learn More</a>
                </div>
            </div>
        ...
        <div className="container flex w-full mt-5 justify-evenly items-center ">
            <div className="left-content w-[35%]">
                ...
                <p className='w-full text-[18px] my-2 leading-none text-[#676767]'>Vertical farming is an innovative method of growing crops and plants by stacking them on vertical multi-level racks inside a controlled-environment building.</p>
                <div className="btn-left mt-10">
                    <a href="" className='py-3 px-5 rounded-full bg-[#313A36] text-white'>Learn More</a>
                </div>
            </div>
