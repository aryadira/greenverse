      ...
      <div className='wrapper'>
        <div>
          ...
          <p className='text-[32px] text-[#676767] max-w-sm'>
            <span className='text-black'>Topics.</span> Get more information out of here
          </p>
          <div className='topics-card flex justify-between flex-wrap w-full mt-4'>
            ...
            <div className='grid grid-cols-2 lg:grid-cols-3 gap-3'>
              <TopicsCard img={topics1} title='Design, Infrastructure, Solutions' desc='The New park of Mars' />
              <TopicsCard img={topics2} title='Design, Infrastructure, Solutions' desc='The New park of Mars' />
              <TopicsCard img={topics3} title='Design, Infrastructure, Solutions' desc='The New park of Mars' />
            </div>
          </div>
        </div>
      </div>
