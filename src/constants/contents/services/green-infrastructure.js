...
import { infraImg1, infraImg2, infraImg3, infraImg4, infraImg5, infraImg6, infraImg7, infraImg8 } from "../../../assets/img";

export const greenInfra = [
  {
    id: 1,
    id_text: "first",
  ...
  },
  {
    id: 3,
    id_text: "third",
    title: "Why Is Green Infrastructure Important?",
    desc: "Depending on the specific needs of a city or community, green infrastructure can be implemented in a wide variety of ways. Common types include:",
    content: [
      {
        id: 1,
        sub_title: "",
        img: [
          {
            id: 1,
            title_img: "Parks and urban forests",
            path: infraImg1,
            desc_img:
              "Creating green spaces in cities not only makes for beautiful features but also provides many environmental and health benefits. City planners can incorporate parks and forests into their designs to improve air and water quality, increase groundwater supply and provide outdoor recreation space.",
          },
          {
            id: 2,
            title_img: "Forests and nature reserves",
            path: infraImg2,
            desc_img:
              "Just as parks are beneficial to cities, forests and nature reserves are beneficial on a broader scale. Large-scale green infrastructure looks at ways to preserve natural areas as well as rehabilitate existing forests and wilderness. Green infrastructure is concerned with creating policies for reforestation and protecting natural lands.",
          },
          {
            id: 3,
            title_img: "Wetlands and constructed wetlands",
            path: infraImg3,
            desc_img:
              "Wetlands often serve as important borders or Transitional environments between ecosystems. They can capture and purify water that is moving from an urban setting to a bay or ocean. Green infrastructure involves the protection and rehabilitation of existing wetlands as well as the construction of wetlands as part of a natural water management system.",
          },
          {
            id: 4,
            title_img: "Bioswales and rain gardens",
            path: infraImg4,
            desc_img:
              "Green infrastructure often uses bioswales and rain gardens as a natural means of stormwater management. Bioswales are shallow linear basins typically built near large impervious surfaces such as roads and parking lots. These basins are filled with gravel or foliage that absorb, purify and slow the movement of the stormwater, which reduces the risk of flooding. Rain gardens are similar to bioswales except that they are often smaller and implemented in residential landscapes.",
          },
          {
            id: 5,
            title_img: "Green transportation",
            path: infraImg5,
            desc_img:
              "Reducing the number of cars on the road is a great way to reduce the emission of CO2 and other harmful greenhouse gases. Green infrastructure can also include creating more mass transportation systems and making it easier for people to walk or bike around the city by adding bike lanes and paths.",
          },
          {
            id: 6,
            title_img: "Green streets",
            path: infraImg6,
            desc_img:
              "A common environmental concern with cities is the creation of urban heat islands, which occurs when the temperature in a city is notably warmer than surrounding rural areas. Excessive urban heat can be due to a variety of issues, including pollution, greenhouse gas emission, more dark surfaces and buildings that reflect light. One way to help reduce urban heat is to creating green streets, which are lined by trees or other foliage that provides shade and reduces the amount of sun being absorbed by the road.",
          },
          {
            id: 7,
            title_img: "Green roofs and walls",
            path: infraImg7,
            desc_img:
              "Another means of reducing urban heat is to grow plants or vines on roofs and walls. Green roofs often have a layer of dirt or gravel that also absorbs rainwater and reduces stormwater runoff.",
          },
          {
            id: 8,
            title_img: "Wildlife habitats and corridors",
            path: infraImg8,
            desc_img:
              "Human developments such as cities and roadways often disrupt natural environments. Building wildlife corridors above roadways and providing wildlife habitats in and around cities connect natural habitats so that animals can move through human settlements freely and safely.",
          },
        ],
        paragraph: [
          {
