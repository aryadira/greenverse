const contentGreenInfrastructureDesign = [
  ...
  },
  {
    ...
    paragraph:
      "Depending on the specific needs of a city or community, green infrastructure can be implemented in a wide variety of ways. Common types include:",
    image: "import dari assets",
    list: [
      {
        idList: 1,
        titleList: "Parks and urban forests",
        paragraphList:
        ...
        imageList: "import from assets (malas download)",
      },
      {
        idList: 2,
        titleList: "Forests and nature reserves",
        paragraphList:
      ...
      {
        idList: 3,
        titleLis: "Wetlands and constructed wetlands",
        paragraphList:
      ...
      {
        idList: 4,
        titleList: "Bioswales and rain gardens",
        paragraphList:
      ...
      {
        idList: 5,
        titleList: "Green transportation",
        paragraphList:
      ...
      {
        idList: 7,
        titleList: "Green roofs and walls",
        paragraphList:
      ...
      {
        idList: 8,
        titleList: "Wildlife habitats and corridors",
        paragraphList:
