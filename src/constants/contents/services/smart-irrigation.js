...
export const smartIrrigation = [
	...
	},
	{
		...
		content: [
			{
				id: 1,
				sub_title: 'Soil Moisture Sensors',
				paragraph: [
					{
						id: 1,
		...
		content: [
			{
				...
				paragraph: [
					{
						id: 1,
						text: 'Oklahoma has an average wind speed of 16 miles per hour (mph) with wind gusts from 20 mph to 30 mph. Watering during windy conditions reduces irrigation distribution uniformity across the landscape and decreases the amount of water infiltrating into the soil profile (Figure 6). Wind sensors interrupt the irrigation cycle if wind speed exceeds a specific threshold (Figure 7).',
					},
					{
						id: 2,
