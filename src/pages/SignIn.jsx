        ...
        <div className='mx-auto flex items-center flex-col'>
          <div className='mt-[60px] mb-[40px] text-center'>
            <div className='font-HaasMd md:text-[56px] text-4xl mb-3 flex  items-center gap-3 title text-center'>
              ...
              Sign In <span className={`font-HaasMd `}>Greenverse</span>
            </div>
            <p className='sm:text-lg text-md text-center text-[#767676] leading-8'>
              What are you waiting for, just log in to get <br />
              the benefits of Greenverse!
            </p>
          </div>
            ...
            <div className='grid space-y-[14px] mt-[30px] w-full text-center'>
              <Link to='/' className='w-full'>
                <Button className='w-full bg-[#313A36] text-white hover:bg-[#0f231a]'>
                  <span className='text-base text-white'>Sign In Now!</span>
                </Button>
              </Link>
              <Link to='/signup'>
                <button type='button'>
                  <span className='text-base text-gray-700 hover:underline'>Don't have an account? Sign up here!!</span>
                </button>
              </Link>
            </div>
          </form>
